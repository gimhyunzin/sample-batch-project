...
@Component
@StepScope
class OrderCompleteAlarmLmsProcessor : ItemProcessor<MutableList<Msg>, MutableList<Msg>> {
    ...
    private fun createLmsMessageList(data : Msg): MutableList<Msg> {
        ...
        for (receiver in data.receiverList) {
            ...
            lmsMessage.kkoTemplateKey = KkoHelper.Template.ORDER_ALARM.key
