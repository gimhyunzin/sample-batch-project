...
import com.sample.batch.common.property.ShareKey.CLAIM_COMPLETE_KKO_LIST
...
@Component
@StepScope
class ClaimCompleteAlarmLmsReader : ItemReader<MutableList<Msg>> {
    ...
    fun loadShareStepExecution(stepExecution: StepExecution) {
        this.dataList = shareData.getData(CLAIM_COMPLETE_KKO_LIST) as MutableList<Msg>? ?: mutableListOf()
    }
}